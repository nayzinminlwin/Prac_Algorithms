...
print("Length : ",sol.Longest_Consecutive([0,3,7,2,5,8,4,6,0,1]))
print("Length : ",sol.Longest_Consecutive([2,20,4,10,3,4,5]))
print("Length : ",sol.Longest_Consecutive([0,3,2,5,4,6,1,1]))
print("Length : ",sol.Longest_Consecutive([100,4,200,1,3,2]))